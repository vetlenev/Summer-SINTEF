classdef GridSetupCase5 < handle
    ...
    methods
        function o = GridSetupCase5(G, n_lowperm_layers, n_imperm_layers, perms)
        ...
        function [trapped_cells] = SetPermeability(o, added_layers, trapped_cells, ...
            ...
            for k=1:numel(layer_types)
                ...
                for i=1:numel(anticline_idxs{k})
                    ...
                    perm(anticline_cells_dummy{k}{i}) = perm_vals{k} + perm_vals{k}*FastGaussian([nxi nzi], 0.8, [o.corr_len_x o.corr_len_z])*strcmp(layer_type, 'lowperm'); % rectangular box around anticline
                    perm(overlapped_cells) = store_perm;
