function fluid = initSimpleADIFluidJfunc(varargin)
...
% viscosities) including Leverett-J function for capillary pressure. 
% Relative permeabilities are modeled as monomial functions
